...
export default function Intro() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="font-bold">Hello, I&apos;m Turdugul (Gul).</span>{' '}
        I&apos;m a <span className="font-bold"> software developer. </span>
        {/*with{' '}
        <span className="font-bold"> years</span> of experience. */}
        I enjoy building <span className="italic">sites & apps</span>. My focus
        is <span className="underline">React (Next.js), Express, Node.js</span>.
      </motion.h1>
